...
public class MatchingProjectApplication {
    ...
    public CommandLineRunner test(UserRepository userRepository,
        ...
        return (args) -> {
            ...
            productRepository.save(new Product("seller1", "블라우스", 20000, "블라우스 입니다.", 200));
            productRepository.save(new Product("seller1", "치마", 30000, "치마 입니다.", 200));
            productRepository.save(new Product("seller1", "바지", 30000, "바지 입니다.", 300));
            productRepository.save(new Product("seller1", "자켓", 40000, "자켓 입니다.", 400));
            productRepository.save(new Product("seller1", "레깅스", 20000, "레깅스 입니다.", 200));
            productRepository.save(new Product("seller2", "셔츠", 20000, "셔츠 입니다.", 200));
            productRepository.save(new Product("seller2", "바지", 20000, "바지 입니다.", 200));
            productRepository.save(new Product("seller2", "재킷", 20000, "재킷 입니다.", 200));
            productRepository.save(new Product("seller3", "패딩", 20000, "패딩 입니다.", 200));
            productRepository.save(new Product("seller3", "후드티", 20000, "후드티 입니다.", 200));
            productRepository.save(new Product("seller3", "후드집업", 20000, "후드집업 입니다.", 200));
            productRepository.save(new Product("seller4", "니트", 20000, "니트 입니다.", 200));
            productRepository.save(new Product("seller4", "목도리", 20000, "목도리 입니다.", 200));
            productRepository.save(new Product("seller4", "스웨터", 20000, "스웨터 입니다.", 200));
            productRepository.save(new Product("seller5", "코트", 20000, "코트 입니다.", 200));
